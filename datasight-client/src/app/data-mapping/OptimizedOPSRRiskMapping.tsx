...
import { fetchResourceOptimizedRiskStatus, fetchServiceOptimizedRiskStatus, fetchProductOptimizedRiskStatus, fetchOfferingOptimizedRiskStatus } from '../api/dataMapping/mapping-functions'
 ...
 const generateNodesAndEdges = useCallback(() => {
  ...
  Array.from(offeringNodes).forEach(
   (offeringNodeId, index) => {
    ...
    const healthColor = healthStatus ? getHealthColor(healthStatus.offering_optimized_risk_status) : 'gray';
  ...
  Array.from(productNodes).forEach(
   (productNodeId, index) => {
    ...
    const healthColor = healthStatus ? getHealthColor(healthStatus.product_optimized_risk_status) : 'gray';
  ...
  Array.from(serviceNodes).forEach(
   (serviceNodeId, index) => {
    ...
    const healthColor = healthStatus ? getHealthColor(healthStatus.service_optimized_risk_status) : 'gray';
  ...
  Array.from(resourceNodes).forEach((resourceNodeId, index) => {
   ...
   const healthColor = healthStatus ? getHealthColor(healthStatus.resource_optimized_risk_status) : 'gray';
