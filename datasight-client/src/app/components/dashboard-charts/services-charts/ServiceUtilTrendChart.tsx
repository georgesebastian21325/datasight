...
function ServiceUtilTrendLineChart({ data }) {
    ...
    const [startMonth, setStartMonth] = useState(monthYearOptions[0]);
    const [endMonth, setEndMonth] = useState(monthYearOptions[monthYearOptions.length - 1]);
    ...
    const filteredData = data
        ...
        .filter(item => {
            ...
            return (
                monthYearOptions.indexOf(itemMonthYear) >= monthYearOptions.indexOf(startMonth) &&
                monthYearOptions.indexOf(itemMonthYear) <= monthYearOptions.indexOf(endMonth)
            );
        })
        .map(item => ({
            ...item,
    ...
    return (
        <ChartContainer
            config={{ cost: { label: "Service Utilization Trend", color: "hsl(var(--chart-1))" } }}
