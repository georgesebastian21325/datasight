...
export function Button({
	...
	return (
		<button
			{...rest}
			className={clsx(
				"flex h-10 items-center rounded-lg bg-black px-4 text-sm transition-transform transform hover:scale-105 font-medium text-white hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 active:bg-blue-600 aria-disabled:cursor-not-allowed aria-disabled:opacity-50",
				className,
			)}
		>
			{children}
