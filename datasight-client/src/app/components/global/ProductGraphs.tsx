...
interface ApiResponseEntryStacked {
	product_id: string;
	service_id: string;
	week: string;
	avg_usage: string;
...
// export function formatDataForStackedChart(
// 	data: ApiResponseEntryStacked[],
// ): StackedFormattedData[] {
// 	const weekMap: { [key: string]: StackedFormattedData } =
// 		{};

// 	data.forEach((entry) => {
// 		const { week, service_id, avg_usage, avg_cost } = entry;
// 		const usage = parseFloat(avg_usage);
// 		const cost = parseFloat(avg_cost);

// 		if (!weekMap[week]) {
// 			weekMap[week] = { week };
// 		}

// 		weekMap[week][service_id] = {
// 			usage,
// 			cost,
// 		};
// 	});
