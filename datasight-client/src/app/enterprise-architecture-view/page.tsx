...
export default function page() {
    return (
        <div className="flex flex-col lg:flex-row h-screen relative">
            ...
            <div className="w-full lg:w-1/4 h-full overflow-auto border-r border-gray-200 p-4 flex flex-col">
                {/* Logo */}
                <div className='mb-8'>
                    <Header />
                </div>
                ...
                <div className="space-y-2 flex-grow">
                    ...
                    <button className="w-full text-left px-4 py-2  hover:bg-blue-800 rounded-md bg-brand-blue text-white transition-transform transform hover:scale-105">Obsolescence</button>
                ...
                <button className="mt-auto mb-4 px-6 py-2 bg-yellow-500 hover:bg-gray-900 text-white rounded">
                    Present With AI
                </button>
            ...
            <div className="w-full lg:w-3/4 h-full overflow-auto p-4 pt-16">
