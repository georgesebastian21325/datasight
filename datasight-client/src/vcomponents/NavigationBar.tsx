...
import {
	...
	SheetContent,
	SheetTrigger,
} from "@/vcomponents/navigation-bar-components/sheet";
	...
	const navItems = [
		{
			...
			message: "Loading Resource Dashboard...",
		},
		{
			name: "Services",
		...
		},
		{
			...
			message: "Loading Product Dashboard...",
		},
		{
			name: "Offerings",
			href: "/dashboard/offerings",
			message: "Loading Offering Dashboard...",
		},
		{
			name: "Enterprise Architecture",
			href: "/enterprise-architecture",
			message: "Loading Enterprise Architecture...",
		},
	];
					...
					<div className="hidden sm:flex sm:items-center space-x-4">
						{navItems.map((item) => (
							<button
								...
								className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 ease-in-out hover:scale-105 ${
									pathname === item.href
								...
								<nav className="flex flex-col gap-4 mt-6 items-start">
									{navItems.map((item) => (
										<button
											...
											className={`px-3 py-2 rounded-md text-[0.8rem] text-base font-medium transition-all duration-200 ease-in-out hover:scale-105 ${
												pathname === item.href
													? "bg-black text-white" // Active style when on the page
